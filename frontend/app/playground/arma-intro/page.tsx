...
export default function ARMAIntroPage() {
  ...
  const generateAR = (phi: number, n = 100) => {
  ...
  const generateMA = (theta: number, n = 100) => {
  ...
  const computeACF = (data: Array<{ t: number; value: number }>, maxLag = 15) => {
  ...
  const createLagPlot = (data: Array<{ t: number; value: number }>) => {
    const plot = [];
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-slate-400 text-lg">
            Interactive playground to understand Autoregressive (AR) and Moving Average (MA) processes
          </p>
        </div>
              ...
              {[
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-semibold text-xs">{concept.label}</span>
                  </div>
                </button>
              ))}
            </div>
            ...
            {selectedConcept === 'what-is-ar' && (
              <div className="space-y-6">
                <div className="bg-slate-800 rounded-lg p-6 border-2 border-blue-600">
                    ...
                    <div className="bg-slate-800 rounded-lg p-4 border border-slate-700">
                      ...
                      <ResponsiveContainer width="100%" height={180}>
                        <ScatterChart margin={{ top: 5, right: 10, left: -20, bottom: 15 }}>
                          <CartesianGrid strokeDasharray="3 3" stroke="#444" />
                          <XAxis dataKey="current" type="number" tick={{ fontSize: 9, fill: '#94a3b8' }} />
                          <YAxis dataKey="next" type="number" tick={{ fontSize: 9, fill: '#94a3b8' }} />
                          <Tooltip contentStyle={{ backgroundColor: '#1e293b', border: '1px solid #475569' }} />
                    ...
                    <div className="bg-slate-800 rounded-lg p-4 border border-slate-700">
                      ...
                      <ResponsiveContainer width="100%" height={180}>
                        <BarChart data={arACF} margin={{ top: 5, right: 10, left: -20, bottom: 15 }}>
                          <CartesianGrid strokeDasharray="3 3" stroke="#444" />
                          <XAxis dataKey="lag" tick={{ fontSize: 9, fill: '#94a3b8' }} />
                          <YAxis domain={[-0.5, 1]} tick={{ fontSize: 9, fill: '#94a3b8' }} />
                          <Tooltip contentStyle={{ backgroundColor: '#1e293b', border: '1px solid #475569' }} />
                  ...
                  <div className="bg-blue-900/50 p-4 rounded mt-6 border-l-4 border-blue-500">
            ...
            {selectedConcept === 'what-is-ma' && (
              <div className="space-y-6">
                <div className="bg-slate-800 rounded-lg p-6 border-2 border-green-600">
                  ...
                  <div className="bg-green-900/50 p-4 rounded mt-6 border-l-4 border-green-500">
                    <p className="text-sm text-slate-300">
            ...
            {selectedConcept === 'white-noise' && (
              <div className="space-y-6">
                <div className="bg-slate-800 rounded-lg p-6 border-2 border-slate-500">
                  ...
                  <div className="bg-slate-700/50 p-4 rounded mt-6 border-l-4 border-slate-500">
                    <p className="text-sm text-slate-300">
